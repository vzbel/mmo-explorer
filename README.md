...
- **Explore**: displays a single MMO game at a time, along with a "re-roll" button to see another random game.
- **Attribute Banning**: allows certain attributes to be banned, excluding games with those attributes from recommendation.
- **History**: displays recently recommended games for quick access.
